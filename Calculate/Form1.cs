    ...
    public partial class fCalc : Form
    {
        ...
        private void bRavno_Click(object sender, EventArgs e)
        {
            ...
            switch (op)
            {
                ...
                case 4:
                    c = a / b;
                    if (Convert.ToDouble(tb_Calc.Text) == 0) MessageBox.Show("Деление на ноль невозможно", "Ошибка", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    break;
                case 5:
                    c = Math.Pow(a, b);
                    break;
        ...
        {
            MessageBox.Show("Автор: Врачинский А.В.\nГруппа: ИС-21", "Об авторе", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
